SELECT 
    ...
    to_timestamp(concat(cast(request_date as text), substring(lpad(request_time ::text,9,'0'),1,4)),'YYYYMMDDHH24MISS') trx_datetime,
...
GROUP BY 
    trx_datetime, bank_code, card_source;