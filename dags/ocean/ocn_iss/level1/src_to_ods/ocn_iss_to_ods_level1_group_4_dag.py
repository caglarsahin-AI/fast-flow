#ocn_iss_to_ods_level1_group_4_dag
import os, json, yaml
...
CONFIG_FILE = os.path.join(CONFIG_PATH, "config_group_4.yaml")
...
with DAG(
    dag_id="ocn_iss_to_ods_level1_group_4",
    default_args=default_args,
    schedule_interval="30 3 * * *",
    catchup=False,
    description="ocn_iss → dwh ETL (Strategy partition)",
    tags=["ocean", "ocn_iss", "src_to_ods", "level1_group_4", "full"],
) as dag:
